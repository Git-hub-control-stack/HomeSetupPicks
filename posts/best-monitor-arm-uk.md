...
One thing the three numbers do not cover: the moment the screen lifts off its stand, the cable that used to hide behind it is suddenly on show. Our [desk mat and cable management guide](best-desk-mat-and-cable-management-uk.html) deals with that half of the desk. Lighting is the other thing an arm changes: raise the screen and a desk lamp starts throwing glare back off the glass, which is the problem our [monitor light bar guide](best-monitor-light-bar-uk.html) is about. A webcam usually clips to the top of that same screen, so getting the arm's height right puts the camera at eye level too. Our [webcam for work calls guide](best-webcam-for-work-calls-uk.html) covers picking one.
